...
@allure.suite("Тест на проверку метода PUT:v1/account/email")
class TestPuV1AccountEmail:
    @allure.sub_suite("Позитивные тесты")
    @allure.title("Проверка смены почтового ящика пользователя")
    def test_put_v1_account_email(self, mailhog_helper, account_helper, prepared_user):
